  ...
  return (
    <section className="flex flex-col md:flex-row items-center gap-10 md:gap-16 w-full bg-white px-4 py-16 md:px-20 fade-in">
      ...
      <div className="w-full md:w-1/2 space-y-6 text-left">
        <span className="inline-flex items-center gap-2 text-green-600 bg-green-100/60 px-2 rounded-lg font-semibold text-sm tracking-wide">
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0" aria-hidden>
            <path d="M4.66669 6.66663L6.00002 7.99996L8.66669 5.33329M12.6667 6.66663C12.6667 7.45456 12.5115 8.23477 12.21 8.96273C11.9084 9.69068 11.4665 10.3521 10.9093 10.9093C10.3522 11.4664 9.69074 11.9084 8.96279 12.2099C8.23483 12.5114 7.45462 12.6666 6.66669 12.6666C5.87876 12.6666 5.09854 12.5114 4.37059 12.2099C3.64263 11.9084 2.9812 11.4664 2.42405 10.9093C1.86689 10.3521 1.42494 9.69068 1.12341 8.96273C0.821882 8.23477 0.666687 7.45456 0.666687 6.66663C0.666687 5.07533 1.29883 3.5492 2.42405 2.42399C3.54926 1.29877 5.07539 0.666626 6.66669 0.666626C8.25799 0.666626 9.78411 1.29877 10.9093 2.42399C12.0345 3.5492 12.6667 5.07533 12.6667 6.66663Z" stroke="#0B6B3A" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          Solution complète
        </span>
        ...
        <div className="space-y-3">
          <div className="flex gap-3 p-4 bg-white rounded-xl border border-gray-100 shadow-sm card-hover hover:shadow-md transition">
            <span className="flex items-center justify-center w-10 h-10 shrink-0 bg-card-icon rounded-lg p-1" aria-hidden>
